...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  EN: {
    ...
    studio_banner_desc: 'Equip your entire studio with tiered commercial volume pricing, guaranteed priority allocation, and ISO sterilization compliance certificates.',
  ...
  ES: {
    ...
    studio_banner_desc: 'Equipa todo tu estudio con descuentos por volumen escalonados, asignación prioritaria y certificados de esterilización ISO.',
  ...
  DE: {
    ...
    studio_banner_desc: 'Statten Sie Ihr Studio mit gestaffelten Mengenrabatten, garantierter Lieferzuteilung und ISO-Zertifikaten aus.',
  ...
  FR: {
    ...
    studio_banner_desc: 'Équipez votre studio avec des tarifs dégressifs, une allocation prioritaire et des certificats de stérilité ISO.',
